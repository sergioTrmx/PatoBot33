      ...
      let isBotAdmin = bot.isAdmin || bot.isSuperAdmin || true // Are you Admin?
        ...
        if (typeof plugin.before == 'function') if (await plugin.before.call(this, m, {
          ...
          if (!isPrems && plugin.limit && global.DATABASE._data.users[m.sender].limit < plugin.limit * 1) {
            this.reply(m.chat, `Su límite ha terminado, puede comprar través de *${usedPrefix}buy*`, m)
            continue
          }
          try {
            ...
            if (m.limit) m.reply(+ m.limit + 'Se aplican limites, Recuerda que tu limite es 20')
          }
    			break
  	  	}
    	}
...
global.dfail = (type, m, conn) => {
  let msg = {
    ...
    mods: 'Este comando solo puede ser utilizado por un moderador del bot!',
    premium: 'Este comando es solo para miembros premium!',
    group: 'Este comando solo se puede usar en grupos!',
    private: 'Este comando solo se puede usar en chats privados!',
    admin: 'Este comando solo puede usado por admin!',
    botAdmin: 'El bot debe ser admin para este comando!',
    unreg: 'Regístrese primero, Ejemplo:\n\n*#reg nombre.edad*\n\nEjemplo: *#reg Pato.99*'
  }[type]
